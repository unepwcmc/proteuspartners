      ...
      describe "documents" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:document, :title => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:document, :title => "A title") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:document, :title => "UniqueTitleOne") }
