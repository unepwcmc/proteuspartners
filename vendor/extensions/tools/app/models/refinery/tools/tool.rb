module Refinery
  module Tools
    class Tool < Refinery::Core::BaseModel
      ...
      attr_accessor :title, :header_image_id, :screen_shot_image_id, :tool_url, :download_description, :short_description, :long_description, :position, :wdpa_link, :protected, :show_wdpa, :homepage_image_id, :download_footer
